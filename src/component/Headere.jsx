...
function Headere() {
    ...
    return (
        <div className='skin-blue'><header className="main-header">
            {/* Logo */}
            <a href="index2.html" className="logo"><b>Employee panel</b></a>
                            ...
                            <NavLink to="/" >
                                {(() => {
                                    if (localStorage.getItem('id')) {
                                        ...
                                        return (
                                            <Link to="/logine" style={{ color: "white" }}>logout</Link>
                                        )
                                    }
                                })()}
            ...
            <aside className="main-sidebar">
                ...
                <section className="sidebar">
                    ...
                    <ul className="sidebar-menu">
                        ...
                        <li className="treeview">
                            <NavLink to="/tablee">
                                <i className="fa fa-table" /> <span>Product Table</span>
                            </NavLink>
                            </li>
                            <li className="treeview">
                            <NavLink to="/table1">
                                <i className="fa fa-table" /> <span>User Table</span>
                            </NavLink>
                            </li>
                        </ul>
