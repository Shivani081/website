...
function Dashboard() {
  return (
  <div className="pull-right hidden-xs"> {/* Right side column. Contains the navbar and content of the page */}
        ...
        <section className="col-lg-7 connectedSortable">
          ...
          <div className="box box-primary">
            ...
            <div className="box-footer clearfix no-border">
              <button className="btn btn-default pull-right"><i className="fa fa-plus" /> Add item</button>
            </div>
          </div>{/* /.box */}
          {/* quick email widget */}
